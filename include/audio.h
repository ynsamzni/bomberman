...
typedef enum{
    MUSIQUE, SON_MENU_TOUCHE_DIRECTIONNELLE, SON_MENU_TOUCHE_BLOQUEE, SON_MENU_TOUCHE_VALIDER, SON_POSE_BOMBE, SON_EXPLOSION_BOMBE, SON_MORT_PERSONNAGE, SON_VICTOIRE, SON_DEFAITE
}SonSelectionne;
